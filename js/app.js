...
try {
  if (SB_URL !== 'https://YOUR_PROJECT.supabase.co' && SB_KEY !== 'YOUR_ANON_KEY_HERE') {
...
// ─── DATA ───
const CATS = [
  { id: 1, name: 'Electronics', icon: 'fas fa-laptop', color: '#C47D4E', count: 12400 },
  { id: 2, name: 'Fashion', icon: 'fas fa-tshirt', color: '#C0544F', count: 18900 },
  { id: 3, name: 'Home & Garden', icon: 'fas fa-couch', color: '#5B8C5A', count: 8700 },
  { id: 4, name: 'Sports', icon: 'fas fa-futbol', color: '#D4A24E', count: 5300 },
  { id: 5, name: 'Books', icon: 'fas fa-book', color: '#7A6558', count: 15200 },
  { id: 6, name: 'Automotive', icon: 'fas fa-car', color: '#A8623A', count: 3400 },
  { id: 7, name: 'Health & Beauty', icon: 'fas fa-heart', color: '#C0544F', count: 9800 },
  { id: 8, name: 'Toys & Games', icon: 'fas fa-puzzle-piece', color: '#D4A24E', count: 6100 },
  { id: 9, name: 'Jewelry', icon: 'fas fa-gem', color: '#C47D4E', count: 4500 },
  { id: 10, name: 'Music', icon: 'fas fa-music', color: '#5B8C5A', count: 3200 },
  { id: 11, name: 'Art & Crafts', icon: 'fas fa-palette', color: '#A8623A', count: 2800 },
  { id: 12, name: 'Pets', icon: 'fas fa-paw', color: '#7A6558', count: 4100 }
];

const PRODS = [
  { id: 1, title: 'Wireless Noise-Cancelling Headphones', price: 89.99, orig: 149.99, cat: 'electronics', cond: 'New', img: 'https://picsum.photos/seed/vo1/400/400.jpg', rate: 4.8, rev: 342, seller: 'AudioHub', flash: true },
  { id: 2, title: 'Premium Leather Crossbody Bag', price: 54.99, orig: 79.99, cat: 'fashion', cond: 'New', img: 'https://picsum.photos/seed/vo2/400/400.jpg', rate: 4.6, rev: 187, seller: 'BagCraft', flash: true },
  { id: 3, title: 'Smart Watch Fitness Tracker Pro', price: 129.99, orig: 199.99, cat: 'electronics', cond: 'New', img: 'https://picsum.photos/seed/vo3/400/400.jpg', rate: 4.7, rev: 521, seller: 'TechWear', flash: true },
  { id: 4, title: 'Organic Cotton Throw Blanket', price: 39.99, orig: 59.99, cat: 'home', cond: 'New', img: 'https://picsum.photos/seed/vo4/400/400.jpg', rate: 4.9, rev: 98, seller: 'CozyNest', flash: true },
  { id: 5, title: 'Running Shoes Ultra Comfort', price: 74.99, orig: 119.99, cat: 'sports', cond: 'New', img: 'https://picsum.photos/seed/vo5/400/400.jpg', rate: 4.5, rev: 267, seller: 'RunFree', flash: true },
  { id: 6, title: 'Vintage Denim Jacket', price: 45, orig: null, cat: 'fashion', cond: 'Good', img: 'https://picsum.photos/seed/vo6/400/400.jpg', rate: 4.3, rev: 64, seller: 'RetroStyle' },
  { id: 7, title: 'Portable Bluetooth Speaker', price: 34.99, orig: 49.99, cat: 'electronics', cond: 'New', img: 'https://picsum.photos/seed/vo7/400/400.jpg', rate: 4.4, rev: 412, seller: 'SoundWave' },
  { id: 8, title: 'Ceramic Plant Pot Set 3-Pack', price: 28.99, orig: null, cat: 'home', cond: 'New', img: 'https://picsum.photos/seed/vo8/400/400.jpg', rate: 4.7, rev: 156, seller: 'GreenHome' },
  { id: 9, title: 'Mystery Novel Collection Bestsellers', price: 19.99, orig: 34.99, cat: 'books', cond: 'New', img: 'https://picsum.photos/seed/vo9/400/400.jpg', rate: 4.8, rev: 89, seller: 'BookHaven' },
  { id: 10, title: 'Yoga Mat Premium Non-Slip', price: 32.99, orig: 44.99, cat: 'sports', cond: 'New', img: 'https://picsum.photos/seed/vo10/400/400.jpg', rate: 4.6, rev: 203, seller: 'ZenFit' },
  { id: 11, title: 'Mechanical Keyboard RGB Backlit', price: 67.99, orig: 89.99, cat: 'electronics', cond: 'New', img: 'https://picsum.photos/seed/vo11/400/400.jpg', rate: 4.7, rev: 678, seller: 'KeyCraft' },
  { id: 12, title: 'Silk Scarf Floral Pattern', price: 22.99, orig: null, cat: 'fashion', cond: 'New', img: 'https://picsum.photos/seed/vo12/400/400.jpg', rate: 4.4, rev: 91, seller: 'SilkRoad' },
  { id: 13, title: 'LED Desk Lamp Adjustable Arm', price: 41.99, orig: 59.99, cat: 'home', cond: 'New', img: 'https://picsum.photos/seed/vo13/400/400.jpg', rate: 4.5, rev: 324, seller: 'BrightSpace' },
  { id: 14, title: 'Wireless Charging Pad Fast', price: 18.99, orig: 29.99, cat: 'electronics', cond: 'New', img: 'https://picsum.photos/seed/vo14/400/400.jpg', rate: 4.3, rev: 547, seller: 'ChargeUp' },
  { id: 15, title: 'Handmade Ceramic Mug Set', price: 26.99, orig: null, cat: 'home', cond: 'New', img: 'https://picsum.photos/seed/vo15/400/400.jpg', rate: 4.9, rev: 112, seller: 'MugLife' },
  { id: 16, title: 'Polarized UV400 Sunglasses', price: 15.99, orig: 24.99, cat: 'fashion', cond: 'New', img: 'https://picsum.photos/seed/vo16/400/400.jpg', rate: 4.2, rev: 389, seller: 'ShadeWorks' },
  { id: 17, title: 'Resistance Bands Set 5-Piece', price: 14.99, orig: 22.99, cat: 'sports', cond: 'New', img: 'https://picsum.photos/seed/vo17/400/400.jpg', rate: 4.6, rev: 178, seller: 'FlexBand' },
  { id: 18, title: 'Stainless Steel Water Bottle', price: 19.99, orig: null, cat: 'sports', cond: 'New', img: 'https://picsum.photos/seed/vo18/400/400.jpg', rate: 4.8, rev: 445, seller: 'HydroMax' }
];

const ORDERS = [
  { id: 'VO-10001', date: '2025-01-10', status: 'delivered', total: 124.98, items: [{ t: 'Wireless Headphones', q: 1, p: 89.99 }, { t: 'LED Desk Lamp', q: 1, p: 41.99 }], rider: 'Marcus T.' },
  { id: 'VO-10002', date: '2025-01-12', status: 'shipping', total: 54.99, items: [{ t: 'Leather Crossbody Bag', q: 1, p: 54.99 }], rider: 'Sarah K.' },
  { id: 'VO-10003', date: '2025-01-14', status: 'pending', total: 142.98, items: [{ t: 'Smart Watch Pro', q: 1, p: 129.99 }, { t: 'Silk Scarf', q: 1, p: 22.99 }], rider: 'Unassigned' }
];

const DELIVS = [
  { id: 'D-001', from: '123 Market St', to: '456 Oak Ave', cust: 'Emily R.', status: 'in-transit', earn: 12.50, time: '12 min ago' },
  { id: 'D-002', from: '789 Pine Rd', to: '321 Elm Blvd', cust: 'James W.', status: 'picked-up', earn: 8.75, time: '25 min ago' },
  { id: 'D-003', from: '555 Cedar Ln', to: '888 Birch Dr', cust: 'Sophie L.', status: 'delivered', earn: 15, time: '1 hr ago' }
];

const EARN = [{ d: 'Mon', a: 145 }, { d: 'Tue', a: 178 }, { d: 'Wed', a: 132 }, { d: 'Thu', a: 187 }, { d: 'Fri', a: 165 }, { d: 'Sat', a: 0 }, { d: 'Sun', a: 0 }];
const PAYOUTS = [
...
// ─── STATE ───
let user = null, cart = [], curPage = 'home', delFee = 4.99, dealSec = 20538, dealTimer = null;
...
function toast(msg, type = 'info') {
  const c = { success: '#5B8C5A', error: '#C0544F', info: '#C47D4E', warning: '#D4A24E' };
  const ic = { success: 'fa-check-circle', error: 'fa-exclamation-circle', info: 'fa-info-circle', warning: 'fa-exclamation-triangle' };
...
function openAuth(mode) {
  ...
  document.getElementById('regForm').classList.toggle('hidden', mode !== 'register');
...
async function doLogin(e) {
  ...
  if (sbOn) {
    ...
    if (!em.includes('@')) { errEl.textContent = 'Enter a valid email'; errEl.classList.remove('hidden'); return; }
    if (pw.length < 3) { errEl.textContent = 'Password too short'; errEl.classList.remove('hidden'); return; }
...
async function doRegister(e) {
  ...
  if (pw.length < 6) { errEl.textContent = 'Password must be 6+ characters'; errEl.classList.remove('hidden'); return; }
  if (sbOn) {
...
function updateAuth() {
  const a = document.getElementById('authBtn'), p = document.getElementById('profBtn');
  if (user) {
    a.classList.add('hidden');
    p.classList.remove('hidden');
    const n = user.name || user.user_metadata?.name || user.email?.split('@')[0] || 'User';
...
function updateCartBadge() {
  ...
  const b = document.getElementById('cartBadge'), m = document.getElementById('mobCartBadge');
  if (n > 0) {
    b.classList.remove('hidden'); b.textContent = n;
    if (m) { m.classList.remove('hidden'); m.textContent = n; }
  } else {
...
function renderCartItems() {
  const ci = document.getElementById('cartItems'), ce = document.getElementById('cartEmpty'), cf = document.getElementById('cartFoot');
  if (!cart.length) { ci.innerHTML = ''; ce.classList.remove('hidden'); cf.classList.add('hidden'); return; }
...
function doCheckout() {
  if (!user) { closeCart(); openAuth('login'); toast('Sign in to checkout', 'warning'); return; }
  if (!cart.length) return;
  closeCart();
  const sub = cart.reduce((s, c) => s + c.price * c.qty, 0);
  document.getElementById('coItems').textContent = cart.reduce((s, c) => s + c.qty, 0);
...
function updCO() {
  const fee = parseFloat(document.querySelector('input[name=spd]:checked')?.value || 4.99);
  delFee = fee;
  const sub = cart.reduce((s, c) => s + c.price * c.qty, 0);
...
function placeOrder(e) {
  e.preventDefault();
  const sub = cart.reduce((s, c) => s + c.price * c.qty, 0), tot = sub + delFee;
...
// ─── SEARCH ───
function doSearch() {
  const q = (document.getElementById('searchInput').value || document.getElementById('mobSearch').value || '').trim().toLowerCase();
  if (!q) { go('home'); return; }
  curPage = 'search';
  renderPage(q);
}
...
function pcard(p) {
  ...
  const st = Array(5).fill(0).map((_, i) => i < Math.floor(p.rate) ? '<i class="fas fa-star text-gold-500 text-[10px]"></i>' : '<i class="far fa-star text-cream-400 text-[10px]"></i>').join('');
...
function openProd(id) {
  ...
  if (!p) return;
  const disc = p.orig ? Math.round((1 - p.price / p.orig) * 100) : 0;
  const st = Array(5).fill(0).map((_, i) => i < Math.floor(p.rate) ? '<i class="fas fa-star text-gold-500"></i>' : '<i class="far fa-star text-cream-400"></i>').join('');
...
function startDealTimer() {
  ...
  dealTimer = setInterval(() => {
    ...
    const h = Math.floor(dealSec / 3600), m = Math.floor((dealSec % 3600) / 60), s = dealSec % 60;
...
function handleSell(e) {
  e.preventDefault();
  if (!user) { openAuth('login'); toast('Sign in to sell', 'warning'); return; }
  toast('Item listed successfully!', 'success');
  e.target.reset();
  document.getElementById('imgPrev').innerHTML = '';
}

function handleRiderApply(e) { e.preventDefault(); toast('Application submitted! We will contact you within 48 hours.', 'success'); e.target.reset(); }

function handleProfUpdate(e) {
  e.preventDefault();
  const n = document.getElementById('profNameIn').value;
  if (n && user) { user.name = n; localStorage.setItem('vo_user', JSON.stringify(user)); updateAuth(); }
  toast('Profile updated!', 'success');
}

function imgPrev(e) {
  const files = e.target.files, con = document.getElementById('imgPrev');
  if (!con) return;
  con.innerHTML = '';
...
function filtOrd(f) {
  document.querySelectorAll('.ord-tab').forEach(t => t.classList.toggle('tab-active', t.dataset.ot === f));
  renderOrders(f);
}

function riderTab(t) {
  document.querySelectorAll('.r-tab').forEach(el => el.classList.toggle('tab-active', el.dataset.rt === t));
...
function renderPage(searchQuery) {
  ...
  else if (curPage.startsWith('cat:')) app.innerHTML = pageCategories(curPage.replace('cat:', ''));
...
// ─── HOME PAGE ───
function pageHome() {
  const flash = PRODS.filter(p => p.flash), trend = PRODS.slice(0, 10), rec = [...PRODS].sort(() => Math.random() - 0.5).slice(0, 6);
  return `
  ...
  <section class="py-16 px-4"><div class="max-w-5xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-8 text-center">${[{ i: 'fa-shield-alt', c: 'caramel', t: 'Secure Payments', d: '256-bit encryption' }, { i: 'fa-undo', c: 'sage', t: 'Easy Returns', d: '30-day guarantee' }, { i: 'fa-headset', c: 'gold', t: '24/7 Support', d: 'Always here' }, { i: 'fa-truck', c: 'terracotta', t: 'Fast Delivery', d: 'Same-day option' }].map(x => `<div><div class="w-14 h-14 rounded-2xl bg-${x.c}-500/10 flex items-center justify-center mx-auto mb-3"><i class="fas ${x.i} text-xl text-${x.c}-500"></i></div><div class="font-semibold text-cream-900 mb-1">${x.t}</div><div class="text-sm text-cream-800">${x.d}</div></div>`).join('')}</div></section>`;
}

// ─── CATEGORIES PAGE ───
function pageCategories(catFilter) {
  let selCat = catFilter || null;
  const catName = selCat ? selCat.replace(/-/g, ' & ').replace(/\b\w/g, c => c.toUpperCase()) : null;
  const filtered = selCat ? PRODS.filter(p => p.cat === selCat.split('-')[0]) : PRODS;
...
// ─── RIDER PAGE ───
function pageRider() {
  const stB = { in: 'bg-caramel-500/10 text-caramel-600', picked: 'bg-gold-500/10 text-gold-600', delivered: 'bg-sage-500/10 text-sage-600' };
...
// ─── ORDERS PAGE ───
function pageOrders() {
  const stC = { pending: 'bg-gold-500/10 text-gold-600', shipping: 'bg-caramel-500/10 text-caramel-600', delivered: 'bg-sage-500/10 text-sage-600' };
  const stI = { pending: 'fa-clock', shipping: 'fa-truck', delivered: 'fa-check-circle' };
...
function renderOrders(f) { document.querySelectorAll('.order-item').forEach(el => { el.style.display = (f === 'all' || el.dataset.status === f) ? '' : 'none'; }); }

// ─── PROFILE PAGE ───
function pageProfile() {
  const n = user ? user.name || user.user_metadata?.name || user.email?.split('@')[0] || 'User' : 'Guest';
...
function pageSearch(q) {
  const results = PRODS.filter(p => p.title.toLowerCase().includes(q.toLowerCase()) || p.cat.includes(q.toLowerCase()) || p.seller.toLowerCase().includes(q.toLowerCase()));
  return `<section class="py-10 px-4"><div class="max-w-7xl mx-auto">
